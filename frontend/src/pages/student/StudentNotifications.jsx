            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="flex border-b border-gray-200 bg-gray-50">
                    <button 
                        ...
                        className={`flex-1 py-4 text-center font-medium transition-colors ${activeTab === 'ALL' ? 'text-blue-600 border-b-2 border-blue-600 bg-white' : 'text-gray-500 hover:bg-gray-100'}`}
                    >
                ...
                <div className="p-6">
                    {loading ? (
                        <div className="text-center py-10 text-gray-500 animate-pulse">Loading your notifications...</div>
                        ...
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-500 mt-1">When you get updates about tickets or bookings, they will show up here.</p>
                        </div>
                    ) : (
                        <div className="space-y-4">
                            {filteredNotifications.map((notif) => (
                                <div 
                                    key={notif.id} 
                                    className={`flex items-start gap-4 p-4 rounded-xl border transition-all ${notif.isRead ? 'bg-white border-gray-100 opacity-75' : 'bg-blue-50 border-blue-100 shadow-sm'}`}
                                >
                                    {/* Icon based on Type */}
                                    ...
                                    {!notif.isRead && (
                                        <button 
                                            ...
                                            className="text-blue-600 hover:text-blue-800 p-2 rounded-full hover:bg-blue-100 transition-colors tooltip"
                                            title="Mark as read"
                                        >
