...
import { FaExclamationCircle, FaEye, FaInfoCircle, FaSpinner, FaTicketAlt } from 'react-icons/fa';
...
const AllTickets = () => {
    ...
    const handleViewTicket = async (ticketId) => {
        try {
            ...
            setDetailsError(error.message || 'Unable to load ticket details.');
        } finally {
    ...
    return (
        <DashboardLayout title="All Tickets">
            <div className="space-y-6">
                <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-[0_20px_50px_rgba(15,23,42,0.06)]">
                    <div className="mb-6 flex items-start gap-3 border-b border-gray-100 pb-5">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-slate-500">View all tickets you have submitted and open details using the View button.</p>
                        </div>
                    </div>
            ...
            {(isDetailsLoading || selectedTicket || detailsError) && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4">
                    <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl">
                        <div className="mb-5 flex items-start justify-between gap-4 border-b border-gray-100 pb-4">
                            <div>
                                <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#f4511e]">Ticket Details</p>
                                <h3 className="mt-1 text-xl font-black tracking-tight text-slate-900">
                                    {selectedTicket ? `Ticket #${selectedTicket.ticketId}` : 'Loading ticket...'}
                                </h3>
                            </div>
                            <button
                                type="button"
                            ...
                            <div className="space-y-4 text-sm text-slate-700">
                                ...
                                {selectedTicket.resolutionNotes && (
                                    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
                                        ...
                                        <p className="mt-1 leading-7 text-amber-900">{selectedTicket.resolutionNotes}</p>
                                    </div>
                                )}
                            </div>
                        )}
