        ...
        const fetchAssignedTickets = async () => {
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(message || 'Failed to load assigned tickets.');
                }
            ...
            <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-[0_20px_50px_rgba(15,23,42,0.06)]">
                <div className="mb-5 flex items-start gap-3 border-b border-gray-100 pb-4">
                    ...
                    <div>
                        ...
                        <h2 className="mt-1 text-2xl font-black tracking-tight text-slate-900">My Assigned Tickets</h2>
                        <p className="mt-2 text-sm text-slate-500">Only tickets assigned to you are shown here.</p>
                    </div>
                </div>
                            ...
                            <tbody className="divide-y divide-gray-100 bg-white">
                                {tickets.map((ticket) => (
                                    <tr key={ticket.ticketId} className="hover:bg-gray-50/70">
                                        ...
                                        <td className="px-4 py-3 text-sm">
                                            <Link
                                                to={`/technician/tickets/${ticket.ticketId}`}
